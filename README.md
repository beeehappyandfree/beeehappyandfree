...
- [getumbrel/llama-gpt](https://github.com/getumbrel/llama-gpt) - A self-hosted, offline, ChatGPT-like chatbot. Powered by Llama 2. 100% private, with no data leaving your device. New: Code Llama support! (3 days ago)
- [useplunk/plunk](https://github.com/useplunk/plunk) - The Open-Source Email Platform (3 days ago)
- [zoom/VideoSDK-Web-Telehealth](https://github.com/zoom/VideoSDK-Web-Telehealth) - This starter-kit uses the Zoom Video SDK to build a telehealth app on Web (3 days ago)
...
- [nfoert/cardie](https://github.com/nfoert/cardie) - An open source business card designer and sharing platform (3 days ago)
- [merlinn-co/merlinn](https://github.com/merlinn-co/merlinn) - Open source AI on-call developer 🧙‍♂️ Get relevant context &amp; root cause analysis in seconds about production incidents and make on-call engineers 10x better 🏎️ (3 days ago)
- [run-llama/llama-agents](https://github.com/run-llama/llama-agents) -  (4 days ago)
- [judygab/nexx-saas](https://github.com/judygab/nexx-saas) -  (4 days ago)
